...
renderingX.renderGrid = function (ctx, originSize, originPos, gridSize, gridOffset, lineOptions, cb) {
    var curGridSlice = new SliceGroup.GridSlice(originSize, originPos, gridSize, gridOffset, lineOptions);
