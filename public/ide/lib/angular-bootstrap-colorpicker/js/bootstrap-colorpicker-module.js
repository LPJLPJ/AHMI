      ...
      return {
        ...
        link: function ($scope, elem, attrs, ngModel) {
          var
              ...
              closeButton = !inline ? '<button type="button" class="close close-colorpicker">确定</button>' : '',
              template =
          ...
          function hideColorpickerTemplate(_clickToClose) {
            if (colorpickerTemplate.hasClass('colorpicker-visible')) {
              colorpickerTemplate.removeClass('colorpicker-visible');
              if (_clickToClose){
                emitEvent('colorpicker-submit')
              }else{
