 ...
 */
ideServices.service('Type', [function () {
    ...
    var MyContacts = this.MyContacts = 'MyContacts';


    this.getFabWidgetByName = function (_typeStr) {
        switch (_typeStr) {
            case MySlide:
                return fabric.MySlide;
            default:
                return null
        }
    };
    ...
    this.isWidget = function (_typeStr) {
        if (_typeStr == this.MySlide || _typeStr == this.MyButton ||
            ...
            _typeStr == this.MyVideo || _typeStr == this.MyAnimation || _typeStr == this.MyTexNum || _typeStr == this.MyTexTime || _typeStr == this.MyContacts) {
            return true;
        }
        return false
    };
