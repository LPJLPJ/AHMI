...
ideServices.
    ...
    this.isWidget= function (_typeStr) {
        if (_typeStr==this.MySlide||_typeStr==this.MyButton||
            ...
            _typeStr==this.MyVideo||_typeStr==this.MyAnimation||_typeStr==this.MyTexNum||_typeStr==this.MySelector||_typeStr==this.MyRotaryKnob||_typeStr==this.General||_typeStr==this.MyTexTime){
            return true;
        }
        return false
    };
