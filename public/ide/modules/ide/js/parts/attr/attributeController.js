	...
	function initUserInterface(){
		$scope.component={
            ...
            transitionMode:[
                ...
                {name:'PUSH UP_LR',show:'从左进入(push)'},
                {name:'PUSH UP_RL',show:'从右进入(push)'},
                {name:'PUSH UP_TB',show:'从上进入(push)'},
                {name:'PUSH UP_BT',show:'从下进入(push)'},
                {name:'SCALE',show:'缩放'},
                {name:'FADE-IN_FADE-OUT',show:'淡入淡出'},
                {name:'HORIZONTAL_SLIDE',show:'水平滑动'},
                {name:'VERTICAL_SLIDE',show:'垂直滑动'},
            ],
            transitionName:null,
