ideServices.service('GenerateTagService',[function () {
    this.generateTagExcel = function (data,project) {

        var path,Excel,fse,fs,gui,__dirname;
        try{
            path = require('path');
        ...
        var localprojectpath = path.join(localProjectDir,String(project.projectId));
        ...
        var fileUrl = path.join(localprojectpath,'tag.xlsx');

        //var fileUrl = path.join(__dirname,'../project',String(project.projectId),'tag.xlsx');
